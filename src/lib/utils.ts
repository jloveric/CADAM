...
export const PARAMETRIC_MODELS: ModelConfig[] = [
  ...
  },
  {
    id: 'openai/gpt-5.5',
    name: 'GPT-5.5',
    description: 'Previous OpenAI flagship; strong CAD generation',
    provider: 'OpenAI',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: true,
  ...
  {
    id: 'openai/gpt-5.4-mini-medium',
    name: 'GPT-5.4 Mini (medium)',
    description: 'Faster/cheaper OpenAI mini with medium reasoning',
    provider: 'OpenAI',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: true,
  },
  {
    ...
    name: 'GPT-5.4 Nano',
    description: 'Cheapest OpenAI model — for connectivity tests',
    provider: 'OpenAI',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: true,
